...
/*   Updated: 2018/09/04 11:44:50 by aguillot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		split_list(t_args_node *elem, t_args_node **front, t_args_node\
		**back);
int			rev_list(t_args_node **head);
void		print_blocks_if_dir_full(t_list *list, t_flags opts, char\
		*dir_name);
...
void		create_list(t_dirent *lu, char *path, t_list *list, t_flags opts);

...
check_for_illegal_opt.c ls_controller.c ls_recursive.c main_ls.c sort_list.c option_l.c print_list_l.c sort_list_t.c check.c get_longest.c get_longest_majmin.c\
...
check_for_illegal_opt.o ls_controller.o ls_recursive.o main_ls.o sort_list.o option_l.o print_list_l.o sort_list_t.o check.o get_longest.o get_longest_majmin.o\
